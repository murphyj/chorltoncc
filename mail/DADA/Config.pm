...
$PROGRAM_ERROR_LOG = '/home7/jmblogge/public_html/chorltonchess/mail/.dada_files/.logs/errors.txt';
...
# Email Templates
	...
	subscribed_by_list_owner_message_subject   => 'Welcome to <!-- tmpl_var list_settings.list_name -->',
	subscribed_by_list_owner_message           => $SUBSCRIBED_BY_LIST_OWNER_MESSAGE,
		
	unsubscribed_by_list_owner_message_subject => 'Unsubscribed from <!-- tmpl_var list_settings.list_name -->',
...
# Dada Bridge Plugin: 
	...
	accept_msg_subject                => 'Message to: <!-- tmpl_var list_settings.list_name --> w/ Subject: <!-- tmpl_var message_subject --> has been accepted.',
	accept_msg                        => $ACCEPT_MSG,
	rejection_msg_subject             => 'Message to: <!-- tmpl_var list_settings.list_name --> Subject: <!-- tmpl_var message_subject --> rejected.',
	rejection_msg                     => $REJECTION_MSG,
	msg_too_big_msg_subject           => 'Message to: <!-- tmpl_var list_settings.list_name -->  Subject: <!-- tmpl_var original_subject --> rejected',
	msg_too_big_msg                   => $MSG_TOO_BIG_MSG,
	msg_labeled_as_spam_msg_subject   => 'Message to: <!-- tmpl_var list_settings.list_name -->  Subject: <!-- tmpl_var original_subject --> Labeled as Spam',
